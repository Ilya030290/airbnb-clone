...
const Header = () => {
  return (
    <header className="p-4 border border-b-gray-200 flex justify-between">
      <a href="src/components/Header/Header" className="flex items-center gap-2">
        <svg
      ...
      <div className="flex gap-3 border border-gray-300 rounded-full px-4 py-2 shadow-md shadow-gray-200">
        <div className="font-semibold">Anywhere</div>
        <div className="border-l border-l-gray-300" />
        <div className="font-semibold">Any week</div>
        <div className="border border-l border-l-gray-300" />
        <div className="text-gray-400">Add guests</div>
        <button className="bg-darkCoral text-white p-2 rounded-full">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
